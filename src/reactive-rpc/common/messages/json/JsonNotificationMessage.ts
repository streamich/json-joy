 ...
 * @category Message
 */
export class JsonNotificationMessage<Data = unknown> extends NotificationMessage<json_string<Data>> implements JsonMessage<Data> {
  ...
  public toCompactJson(): json_string<CompactNotificationMessage<Data>> {
    if (this.data) return '["' + this.method + '",' + this.data + ']' as json_string<CompactNotificationMessage<Data>>;
