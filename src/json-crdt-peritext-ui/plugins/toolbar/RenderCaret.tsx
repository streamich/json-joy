  ...
  return (
    <span className={blockClass}>
      ...
      <span className={overClass} contentEditable={false}>
        <Paper hoverElevate>
          <Flex style={{padding: 8, alignItems: 'center'}}>
            <BasicButton size={32} width={32} onClick={() => {}}>
