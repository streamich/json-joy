 ...
 */
const RESERVED_SESSION = 0;

/**
 * Represents some sort of root element or is simply the bottom value of a
 * logical timestamp.
 */
export const ORIGIN = new LogicalTimestamp(RESERVED_SESSION, 0);
 
/**
 * JSON "null" literal value.
 */
export const NULL_ID = new LogicalTimestamp(RESERVED_SESSION, 1);
 
/**
 * JSON "true" literal value.
 */
export const TRUE_ID = new LogicalTimestamp(RESERVED_SESSION, 2);
 
/**
 * JSON "false" literal value.
 */
export const FALSE_ID = new LogicalTimestamp(RESERVED_SESSION, 3);
 ...
 */
export const UNDEFINED_ID = new LogicalTimestamp(RESERVED_SESSION, 4);
