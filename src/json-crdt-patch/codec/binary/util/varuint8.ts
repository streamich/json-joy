...
export const encodeVarUint8 = (uint: number): number[] => {
  ...
  if (uint <= 0b1111111_1111111) return [0b10000000 | (uint & 0b1111111), (uint & 0b1111111_0000000) >> 7];
 ...
 */
export const encodeVarUint8Buf = (uint: number): Uint8Array => new Uint8Array(encodeVarUint8(uint));
...
export const decodeVarUint8 = (buf: Uint8Array, offset: number): [num: number, offset: number] => {
  ...
  const o4 = buf[offset++];
  if (o4 <= 0b01111111)
    return [(o4 << 21) | ((o3 & 0b01111111) << 14) | ((o2 & 0b01111111) << 7) | (o1 & 0b01111111), offset];
  const o5 = buf[offset++];
  if (o5 <= 0b01111111)
    return [
