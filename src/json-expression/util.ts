...
export const isEmail = (value: unknown): boolean =>
  typeof value === 'string' && EMAIL_REG.test(value);
export const isHostname = (value: unknown): boolean =>
  typeof value === 'string' && HOSTNAME_REG.test(value);
export const isIp4 = (value: unknown): boolean =>
  typeof value === 'string' && IP4_REG.test(value);
export const isIp6 = (value: unknown): boolean =>
  typeof value === 'string' && IP6_REG.test(value);
export const isUuid = (value: unknown): boolean =>
  typeof value === 'string' && UUID_REG.test(value);
export const isUri = (value: unknown): boolean =>
  typeof value === 'string' && NOT_URI_FRAGMENT_REG.test(value) && URI_REG.test(value);
export const isDuration = (value: unknown): boolean =>
  typeof value === 'string' && DURATION_REG.test(value);
