import type {Expr, ExprAnd, ExprBool, ExprEquals, ExprGet, ExprIf, ExprNot, ExprNotEquals, ExprOr, ExprType, JsonExpressionCodegenContext, JsonExpressionExecutionContext} from './types';
