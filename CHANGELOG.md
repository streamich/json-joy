...
* **reactive-rpc:** 🐛 do not fetch method, in case it does not exist ([a27a911](https://github.com/streamich/json-joy/commit/a27a91169005d54669299608f4cdb3fccd1a9cd6))
...
* **json-expression:** 🐛 correct equals operator ([f108051](https://github.com/streamich/json-joy/commit/f108051fc7c462a74bc62c40a69d00b668c0d872))
* **json-pack:** 🐛 encode large number correctly ([3cbb8a1](https://github.com/streamich/json-joy/commit/3cbb8a1caa6cbe0d240c707073ef0e389d915edd))
* **json-random:** 🐛 improve random type generation ([9e3b552](https://github.com/streamich/json-joy/commit/9e3b55275a4ec3fd1f3b2ca36cf80c502c9b410c))
* **json-type-codegen:** 🐛 use correct check for const ([aa05f8b](https://github.com/streamich/json-joy/commit/aa05f8be5ca64d4a2a1abfb6b89a0496f95a252e))
* **json-type-validator:** 🐛 correctly check boolean and number consts ([75ec6b3](https://github.com/streamich/json-joy/commit/75ec6b34be2d2435bdb6ff22d8baa98ad045fd62))
* **json-type-validator:** 🐛 correctly validate "null" ([fc48bfd](https://github.com/streamich/json-joy/commit/fc48bfdd0464a38637971c44c32ea6c6f7ea3c14))
* **json-type-validator:** 🐛 correctly validate number and string consts ([404aafb](https://github.com/streamich/json-joy/commit/404aafb0a03e8b5cdce7ef90a6d4d6f0e5d4a75a))
* **json-type-validator:** 🐛 correctly validate string constants ([f9dd247](https://github.com/streamich/json-joy/commit/f9dd2476986cb8e95cd5c9ebac314bc36d032d75))
* **json-type-validator:** 🐛 don't check expra fields in empty objects ([6d839a9](https://github.com/streamich/json-joy/commit/6d839a94c4cf9028e8ac1bc3f0289bca0af2b44e))
* **json-type-validator:** 🐛 handle correctly boolean constants ([5709d82](https://github.com/streamich/json-joy/commit/5709d8265a7a488a9e59a83c57c1335074303a0c))
* **json-type-validator:** 🐛 make "or" clause work again ([d71dd68](https://github.com/streamich/json-joy/commit/d71dd6859f262bab9866fde11ab74d7b48290d49))
* **reactive-rpc:** 🐛 complete single message req calls immediately ([81b1f69](https://github.com/streamich/json-joy/commit/81b1f6951ab6cacd0e90bd52e7c38f11a46c6d0e))
* **reactive-rpc:** 🐛 correct TypeScript errors ([5893334](https://github.com/streamich/json-joy/commit/5893334551caf1a2862e943f6be7d357e55a6bfa))
* **reactive-rpc:** 🐛 support polymorphic stream functions ([c2827a3](https://github.com/streamich/json-joy/commit/c2827a37726544affad5950f2c676c4f55a77b47))
* **reactive-rpc:** 🐛 use correct static method when reading streaming c ([dc57dc9](https://github.com/streamich/json-joy/commit/dc57dc9dea4903a32d9ce1a5da517230f8fd32fd))
* 🐛 import hasOwnProperty() from shared location ([61533a5](https://github.com/streamich/json-joy/commit/61533a5fa28b81dbf350421652a98edf5a276b9b))


### Features

* **json-expression:** 🎸 add "between" operator support to evaluator ([f082456](https://github.com/streamich/json-joy/commit/f082456b24d47a429e4c0cc1ee49df6fee0e2dea))
* **json-expression:** 🎸 add "between" operators ([1403dfd](https://github.com/streamich/json-joy/commit/1403dfdcc548d2f70438b4cdf36b3fae9c003dd5))
* **json-expression:** 🎸 add "cat" expression ([561a639](https://github.com/streamich/json-joy/commit/561a639427daca4dd7d5098dba54c6b0550e3f18))
* **json-expression:** 🎸 add "cat" operation ([9146080](https://github.com/streamich/json-joy/commit/914608096d7b6114b96939ddbf5f1cf82778feb0))
* **json-expression:** 🎸 add "defined" expression ([d2e9ec1](https://github.com/streamich/json-joy/commit/d2e9ec11239253cb3f0a2c47a3a15836b20d2c75))
* **json-expression:** 🎸 add "if" operation ([31aeb41](https://github.com/streamich/json-joy/commit/31aeb415602a4522b654a8c1b6d0039bd4fb3dee))
* **json-expression:** 🎸 add "in" expression ([be2e4e8](https://github.com/streamich/json-joy/commit/be2e4e8023e7541c8345bd543adce2c34d263a46))
* **json-expression:** 🎸 add "min" and "max" expressiosn ([cf9be64](https://github.com/streamich/json-joy/commit/cf9be64d12f5db3845cd4386faf44830eee05ba3))
* **json-expression:** 🎸 add "starts" expression ([f99caa7](https://github.com/streamich/json-joy/commit/f99caa7f992b453d3119392bd26064144b09c6b0))
* **json-expression:** 🎸 add "substr" operation ([fcd6855](https://github.com/streamich/json-joy/commit/fcd685514a6ee442cf4b117268b5cb6dc2784228))
* **json-expression:** 🎸 add "type" expression ([b57f7d3](https://github.com/streamich/json-joy/commit/b57f7d3e8053e69ba70cf3220fee1db26269ffa1))
* **json-expression:** 🎸 add context ([e78ebbe](https://github.com/streamich/json-joy/commit/e78ebbe87652ff763c3100a4b99b7a121b2e14e8))
* **json-expression:** 🎸 add math operations ([7b9cb4b](https://github.com/streamich/json-joy/commit/7b9cb4b958cc5cc70e7e7111f72b2006ba86b92c))
* **json-expression:** 🎸 add not equals operator ([a07aaef](https://github.com/streamich/json-joy/commit/a07aaefd1588053ca8eb00d17f2407c7569dc2fd))
* **json-expression:** 🎸 add number comparison expressions ([ae1be14](https://github.com/streamich/json-joy/commit/ae1be14a0dce07f142f3d62eeea8af23e9b3c374))
* **json-expression:** 🎸 add support for "contains" and "ends" expr ([4cd5a74](https://github.com/streamich/json-joy/commit/4cd5a748eecad5a162242f7102aa51dac1b48fec))
* **json-expression:** 🎸 add type conversion expressions ([df461e7](https://github.com/streamich/json-joy/commit/df461e71d7c017c61a9a7766b5a4aeb84d6423d7))
* **json-expression:** 🎸 improve "in" operator ([c0852d1](https://github.com/streamich/json-joy/commit/c0852d154a21722e01cd8d23349f4b6706c9d66d))
* **json-expression:** 🎸 improve context types ([8423c38](https://github.com/streamich/json-joy/commit/8423c384fcb4bd0d23f1bceb74aef4f28cfea48e))
* **json-pack:** 🎸 expose integer encoding methods ([bfb5ac9](https://github.com/streamich/json-joy/commit/bfb5ac9ec51a16608ffc3b318735be2813635178))
* **json-type:** 🎸 add optimizatoin annotations ([ed50eed](https://github.com/streamich/json-joy/commit/ed50eed4885f007f740a38de138a320d7b7419a1))
* **json-type:** 🎸 add validator properties ([c3cbdc0](https://github.com/streamich/json-joy/commit/c3cbdc03f9d838c157f6d37b810f5bf9fd56ff04))
* **json-type:** 🎸 improve types and builder ([feba569](https://github.com/streamich/json-joy/commit/feba569c07ed4c0d6aa2415e8b905ee62485ae20))
* **json-type-serializer:** 🎸 add binary support for JSON serializer ([dd34cb3](https://github.com/streamich/json-joy/commit/dd34cb3ecf92c727838c5f313b5974b9386887cd))
* **json-type-serializer:** 🎸 add fast path for integer encoding ([ca838d3](https://github.com/streamich/json-joy/commit/ca838d3d1bd78408c369954d76c696cdd7bc5ace))
* **json-type-serializer:** 🎸 add support for "any" type ([2699daf](https://github.com/streamich/json-joy/commit/2699daf2fcd8f4d7cb312ec6cff5f082dcb87eb2))
* **json-type-serializer:** 🎸 add support for "enum" type ([1755f81](https://github.com/streamich/json-joy/commit/1755f8119f12369aac43e90d730b85073437c88a))
* **json-type-serializer:** 🎸 add support for "or" type ([c4208db](https://github.com/streamich/json-joy/commit/c4208dbec9dd5a4ebe51985bdd3ce24bb0a6927d))
* **json-type-serializer:** 🎸 add support for "ref" types ([ea9659f](https://github.com/streamich/json-joy/commit/ea9659f5029994c01d8774356b3ca46df062ff82))
* **json-type-serializer:** 🎸 export JSON serializer ([48ab1a0](https://github.com/streamich/json-joy/commit/48ab1a05fbd8d4ee410f725da1970909c9717c11))
* **json-type-serializer:** 🎸 implement inital "str" serialization ([cb37930](https://github.com/streamich/json-joy/commit/cb37930d7eca588b7f4c4440d8a5179c8c40132d))
* **json-type-serializer:** 🎸 improve "arr" and add "obj" serialization ([836fd7f](https://github.com/streamich/json-joy/commit/836fd7fb2401b8c01bd1c37f1b11fa25fb5cd4af))
* **json-type-serializer:** 🎸 link in serialize method ([e64704f](https://github.com/streamich/json-joy/commit/e64704f876e9e46cc1df6f0f0b3df532da403616))
* **json-type-validator:** 🎸 add ability to provide custom validator ([df5543a](https://github.com/streamich/json-joy/commit/df5543a8f28d5b0cfe7bd09c31e4a898f5e97d10))
* **json-type-validator:** 🎸 improve custom validators to allow throwin ([a42475f](https://github.com/streamich/json-joy/commit/a42475f8e3a841ccf433668d98ca58d63e16dbe4))
* **util:** 🎸 add ability to name code-generated function ([6863bba](https://github.com/streamich/json-joy/commit/6863bbaefa12cc75a40aa667b14a21b6191a9275))
* **util:** 🎸 add asString() method ([ffe6c9f](https://github.com/streamich/json-joy/commit/ffe6c9ff297303173f2cddf215f9bcf53f4e08ca))
* **util:** 🎸 add base64 encoder ([2d0656c](https://github.com/streamich/json-joy/commit/2d0656c3cb1b385e46338c382f9a199e314fead6))
* **util:** 🎸 implement Codegen class ([a9ab412](https://github.com/streamich/json-joy/commit/a9ab4122680e7528b9f72cac797fcaaa6dbdece4))
* **util:** 🎸 improve asString() method ([f7f0798](https://github.com/streamich/json-joy/commit/f7f0798a18a79dd6c63833a382a3a2d63d151473))
* **util:** 🎸 improve Codegen API ([336881f](https://github.com/streamich/json-joy/commit/336881f667fe718883e897b96d013cb37cb41c0d))
* **util:** 🎸 start codegen switch implementation ([7333c95](https://github.com/streamich/json-joy/commit/7333c9577677a82c151a3954c08b114094f2b414))
* 🎸 add "and" expression ([7ddf2d0](https://github.com/streamich/json-joy/commit/7ddf2d07a545ce70b7830c4005d89e92a37c907c))
* **json-brand:** 🎸 add global type definition ([8237fc4](https://github.com/streamich/json-joy/commit/8237fc424666da3a4a8b4e1b08d2b24ae47220a8))
* **json-brand:** 🎸 vendor JSON brand library ([84297f8](https://github.com/streamich/json-joy/commit/84297f8e697f36a6c4e038ce2253eb0011369532))
* **json-expression:** 🎸 add "ends" expression ([cc5f6d3](https://github.com/streamich/json-joy/commit/cc5f6d3e0b813f8bab7445d40c6d14bebf57d0ad))
* **json-expression:** 🎸 add "in" operand ([cf7f6a0](https://github.com/streamich/json-joy/commit/cf7f6a06c410ae49bf765fa25ab359867c4a30ca))
* **json-expression:** 🎸 add "matches" expression ([abf53f9](https://github.com/streamich/json-joy/commit/abf53f948d777d9c2d98790a072d2c03b9a38b34))
* **json-expression:** 🎸 add "min" and "max" expressions ([7518a39](https://github.com/streamich/json-joy/commit/7518a39e874ac4dfd0da36e95dab37fd934e9918))
* **json-expression:** 🎸 add "mod" expression ([f920239](https://github.com/streamich/json-joy/commit/f9202394f5c2d56718afacc8dedfd5b980ce202c))
* **json-expression:** 🎸 add "substr" expression ([43d2272](https://github.com/streamich/json-joy/commit/43d2272b9278893a66614e640b0ef1fe73451930))
* **json-expression:** 🎸 add codege support for "ne" expression ([4e04425](https://github.com/streamich/json-joy/commit/4e044257f6675cfb1d105d646c910f11d50b3a45))
* **json-expression:** 🎸 add default value for get expression ([1042267](https://github.com/streamich/json-joy/commit/1042267c0bb4422bfcf1181e2c139f724ec5805c))
* **json-expression:** 🎸 add ends() and contains() helpers ([843222e](https://github.com/streamich/json-joy/commit/843222e4dd133c0d7021018400b75da2ddab4056))
* **json-expression:** 🎸 add equality comparators ([babf9b8](https://github.com/streamich/json-joy/commit/babf9b8c242dd4012919bd9dcad2869bb4eb481e))
* **json-expression:** 🎸 add rounding expressions ([8e7451c](https://github.com/streamich/json-joy/commit/8e7451ce68180e6d59334619509a2d2e23865e48))
* **json-expression:** 🎸 add support for "not" expression ([ae9c3bf](https://github.com/streamich/json-joy/commit/ae9c3bffbe2ad969ae43d41f8d5a93318132658e))
* **json-expression:** 🎸 begin codegen implementation ([9e6ea71](https://github.com/streamich/json-joy/commit/9e6ea713e1c6f7502a971f52730f7d875285b479))
* **json-expression:** 🎸 bring evaluator to feature parity ([e5b3c5d](https://github.com/streamich/json-joy/commit/e5b3c5de9ab249ee51c4cfe875b4424bd206ffe5))
* **json-expression:** 🎸 implement "and" expression ([8cdc133](https://github.com/streamich/json-joy/commit/8cdc133603752ff627a91f893819506296518dea))
* **json-expression:** 🎸 implement "bool" expression ([5af82fb](https://github.com/streamich/json-joy/commit/5af82fb595d66fad6525737b8bcdf5c3011ff431))
* **json-expression:** 🎸 implement "contains" expression ([1501d4a](https://github.com/streamich/json-joy/commit/1501d4ae2b61761aecb140726098a58569574d18))
* **json-expression:** 🎸 implement "defined" expression ([abcb625](https://github.com/streamich/json-joy/commit/abcb625c09e1910d203127759f8ef9ddd1e9b68b))
* **json-expression:** 🎸 implement "if" expression ([6675495](https://github.com/streamich/json-joy/commit/667549525c3a8ea5213a9c093ed10f8a70df200e))
* **json-expression:** 🎸 implement "int" expression ([d2d52f6](https://github.com/streamich/json-joy/commit/d2d52f695c6a41ea43cfac86a13768aa40fc6f5e))
* **json-expression:** 🎸 implement "num" expression ([7fc6aac](https://github.com/streamich/json-joy/commit/7fc6aac3ce4c648127366e52387d2f176dba26ab))
* **json-expression:** 🎸 implement "or" expression ([5dccfce](https://github.com/streamich/json-joy/commit/5dccfce3ebe565feb4d41090311631797ce1d82d))
* **json-expression:** 🎸 implement "str" expression ([afab884](https://github.com/streamich/json-joy/commit/afab884838e8537e234459af6645c0d5430dcb83))
* **json-expression:** 🎸 implement "type" expression ([be8aaeb](https://github.com/streamich/json-joy/commit/be8aaeb97541a03d41a8fa85f7f855f80fc4f085))
* **json-expression:** 🎸 implement arithmetic operands ([7db93be](https://github.com/streamich/json-joy/commit/7db93be80b4b8f22e441b7ef2652fc71f8f7bb99))
* **json-expression:** 🎸 implement codegen for "get" expression ([02bd3f8](https://github.com/streamich/json-joy/commit/02bd3f859e03bdcf8ac8e6512680cb8ccea294c0))
* **json-expression:** 🎸 implement codegen for "start" expression ([68f2c8a](https://github.com/streamich/json-joy/commit/68f2c8a91eecf0913fd63f597082833fe8ab4db0))
* **json-expression:** 🎸 improve operand count error messages ([5b3fc51](https://github.com/streamich/json-joy/commit/5b3fc51baa96d081e81944ddd7421359b9f1bc18))
* **json-pointer:** 🎸 implement get() method ([81691de](https://github.com/streamich/json-joy/commit/81691dec94b7d74bb6a063082ac8b8215867badc))
* **json-pointer:** 🎸 use .hasOwnProperty() from prototype ([fd59781](https://github.com/streamich/json-joy/commit/fd59781c9ad8a2451bb10d63cc445c8bb73962cf))
* **json-random:** 🎸 add methods to generate specific type ([2ce945d](https://github.com/streamich/json-joy/commit/2ce945d42af5b8c52b73f328d8237fdb54362ef7))
* **json-random:** 🎸 implement random generator according to json-type ([e84665c](https://github.com/streamich/json-joy/commit/e84665c14949ef8b41d8c2ac6a009a797bb2899b))
* **json-random:** 🎸 respect integer types ([63dec85](https://github.com/streamich/json-joy/commit/63dec8542dd61e91dc20e6bc491596d715256fda))
* **json-type:** 🎸 add "enum" type ([2c48b6e](https://github.com/streamich/json-joy/commit/2c48b6e03da45e4d4b9b2e30cf9d0b4a9f922aa5))
* **json-type:** 🎸 add "or" type and move to new file ([08d3767](https://github.com/streamich/json-joy/commit/08d376715d592019966821f55ade30067a2732a7))
* **json-type:** 🎸 add "ref" type ([63dd6c5](https://github.com/streamich/json-joy/commit/63dd6c5d03d5730b580bb8ea83c56a008865729d))
* **json-type:** 🎸 add basic json-type to TypeScript output ([709defe](https://github.com/streamich/json-joy/commit/709defe59a7a20808b55b274784cae9afc82a014))
* **json-type:** 🎸 add comment props ([1a27b99](https://github.com/streamich/json-joy/commit/1a27b9920756cb442205371a186e97a21f3ebead))
* **json-type:** 🎸 add unknownFields property ([3b3208b](https://github.com/streamich/json-joy/commit/3b3208bceb1f2a2b56922756017efeb0ad19e27a))
* **json-type:** 🎸 export types ([df04b58](https://github.com/streamich/json-joy/commit/df04b58c22f2c3730c8f6b959bf8a310e876b84c))
* **json-type:** 🎸 group types better ([bd17d1d](https://github.com/streamich/json-joy/commit/bd17d1dc10ae2c3f71dae8613962f3dc2db3293d))
* **json-type:** 🎸 implement recursive references for full validator ([f7c6f6d](https://github.com/streamich/json-joy/commit/f7c6f6d77e7c07da664493d8492657425f56ca7d))
* **json-type:** 🎸 implement recursive type refs ([68c5f71](https://github.com/streamich/json-joy/commit/68c5f7183de2bd8e5ca42522a87eef9eba6808df))
* **json-type:** 🎸 improve builder to easily add type names ([0e558cf](https://github.com/streamich/json-joy/commit/0e558cf8cd6d08a59c20d1909599d9f4a6fd5df1))
* **json-type:** 🎸 improve type definitions ([a00e814](https://github.com/streamich/json-joy/commit/a00e814c123aa5b115c48d4e0f5bb415b35ab916))
* **json-type:** 🎸 improve types ([5884bd4](https://github.com/streamich/json-joy/commit/5884bd47214610b41e45f906510fada14fa39f0a))
* **json-type:** 🎸 simplify object field creation ([b428984](https://github.com/streamich/json-joy/commit/b42898464578786968db6c25d1e9ba4a80d8e589))
* **json-type:** 🎸 support JSON serialization ([6a7a14e](https://github.com/streamich/json-joy/commit/6a7a14e4cad283b9bfc861af4789f84fa06de733))
* **json-type-codegen:** 🎸 add ability to disable errors ([81c8eab](https://github.com/streamich/json-joy/commit/81c8eab580579f4d610fe54595acea9c9047754c))
* **json-type-codegen:** 🎸 add ability to skip object check ([7c8c6e5](https://github.com/streamich/json-joy/commit/7c8c6e530aeec5d850886697973aaabc4af68841))
* **json-type-codegen:** 🎸 allow skipping extra field check ([dbd1e52](https://github.com/streamich/json-joy/commit/dbd1e52862745e6ebb5f0250c175ca21f80af3d6))
* **json-type-codegen:** 🎸 implement different types of error reporting ([dbe01d9](https://github.com/streamich/json-joy/commit/dbe01d9d7f00f9d360c13f87175f54a7fc0e7c3a))
* **json-type-codegen:** 🎸 implement object and one-of validation ([ded2193](https://github.com/streamich/json-joy/commit/ded219330e01876995938e930741a31a9dadca50))
* **json-type-codegen:** 🎸 implement validation for arrays ([66d1d27](https://github.com/streamich/json-joy/commit/66d1d2768cc06f25892c50fea3aa8de19398dd65))
* **json-type-codegen:** 🎸 implement validation for basic types ([0dc0851](https://github.com/streamich/json-joy/commit/0dc08511c0f94c8be5ad85035ff444fdc422dd1a))
* **json-type-codegen:** 🎸 improve error reporting ([0775887](https://github.com/streamich/json-joy/commit/07758871b177339f0a474e59f6ce60b2537d54ec))
* **json-type-codegen:** 🎸 support unknown fields in serializ ([f8588ff](https://github.com/streamich/json-joy/commit/f8588ff557443980dd5cb01c07805f190e8f7953))
* **json-type-codegen:** 🎸 use boolean error reporting by default ([ff00ea6](https://github.com/streamich/json-joy/commit/ff00ea6df69caef795b1bd7ed101e10df80db22d))
* **json-type-schema:** 🎸 add ability to generate defs ([bb4c4f9](https://github.com/streamich/json-joy/commit/bb4c4f9f9063f46fbb94d2cf94759106ccc9961a))
* **json-type-schema:** 🎸 implement json-type to JSON Schema converter ([0e50d9c](https://github.com/streamich/json-joy/commit/0e50d9ce8683e63badcc0c30f97837d405e57027))
* **json-type-serializer:** 🎸 add support for recursive refs to JSON ([88aabe0](https://github.com/streamich/json-joy/commit/88aabe0ed06c3043f45a4829a94cdee69138cb5a))
* **json-type-serializer:** 🎸 support partial serializer as ref ([3b5dc4b](https://github.com/streamich/json-joy/commit/3b5dc4b7aef80006a13ea458bb3f677c58841b6a))
* **json-type-system:** 🎸 add ability to convert json-type to JSON Sch ([6b72273](https://github.com/streamich/json-joy/commit/6b722736f09b87fe0b5ff5374cfda6beffbb8eb4))
* **json-type-system:** 🎸 add ability to export the whole type system ([0275958](https://github.com/streamich/json-joy/commit/02759586af7b2e582278a2e2092df8d4bd8f6548))
* **json-type-system:** 🎸 add MessagePack serializer ([5fde08b](https://github.com/streamich/json-joy/commit/5fde08bd348d396896964412b3a395a6aacc9181))
* **json-type-system:** 🎸 add namespaces support ([1917b04](https://github.com/streamich/json-joy/commit/1917b042e202d37975d1f67377a0bb0e4edae462))
* **json-type-system:** 🎸 add support for array and numbers ([30c8719](https://github.com/streamich/json-joy/commit/30c8719c916eb2c6686530a4ebb4441671ddde2f))
* **json-type-system:** 🎸 add support for TypeScript type literals ([79eb181](https://github.com/streamich/json-joy/commit/79eb181290739683fe41ec9024aba7f63750d84a))
* **json-type-system:** 🎸 add support for unknown fields ([ddadc3c](https://github.com/streamich/json-joy/commit/ddadc3ccd0699eaa62a8a55d9efa9ac57e34bd22))
* **json-type-system:** 🎸 add TypeScript comments for interface decls ([907afab](https://github.com/streamich/json-joy/commit/907afab17df79ddae542fb1203bce16d3a9e4041))
* **json-type-system:** 🎸 add TypeScript comments support for propertie ([a58b564](https://github.com/streamich/json-joy/commit/a58b564041c515944c2b9f8dcf4e31413927a395))
* **json-type-system:** 🎸 do not re-declare already declared types ([47aabf2](https://github.com/streamich/json-joy/commit/47aabf24a0dcb558b08b45777663513513507ed2))
* **json-type-system:** 🎸 emit TypeScript text for all AST nodes ([2b7bc19](https://github.com/streamich/json-joy/commit/2b7bc198257f34ae7b77c224f6c23e4d3bda757a))
* **json-type-system:** 🎸 enable auto-completion for types ([b832832](https://github.com/streamich/json-joy/commit/b83283204e54a822cc71480b351d1b9a26462481))
* **json-type-system:** 🎸 export TypeScript declarations ([5387174](https://github.com/streamich/json-joy/commit/5387174b9910ea22d8bee03646b244d85e65fa3f))
* **json-type-system:** 🎸 start TypeScript AST to text converter fn ([fe4ccce](https://github.com/streamich/json-joy/commit/fe4ccce5e1819c13fd1dfda12d259bfade3f73fb))
* **json-type-system:** 🎸 support comments for type declarations ([7752860](https://github.com/streamich/json-joy/commit/77528605fde262f68e77dfb2206d192fce57284e))
* **json-type-system:** 🎸 support custom validators and fix full valid ([de6fad5](https://github.com/streamich/json-joy/commit/de6fad5a5e7ca62c49f08cd1c4c348d08ae7ea7f))
* **json-type-system:** 🎸 support TypeScript module nesting ([7f66df3](https://github.com/streamich/json-joy/commit/7f66df3af5c9667b30de166c22ba64df1cc04748))
* **json-type-validator:** 🎸 add support for "any" type ([d3821ba](https://github.com/streamich/json-joy/commit/d3821bacc1bc027e461170f884c4a44e3e130a47))
* **json-type-validator:** 🎸 add support for "enum" type ([7185e61](https://github.com/streamich/json-joy/commit/7185e616a6756e1914e088218f9f709782f758eb))
* **json-type-validator:** 🎸 add support for integers ([ee5a445](https://github.com/streamich/json-joy/commit/ee5a44545b67b8995ca942daff13ba567520698e))
* **json-type-validator:** 🎸 add support for minLength and maxLength ([f1639ea](https://github.com/streamich/json-joy/commit/f1639eab51c6832a6f3e1ffdfcafbd09b7247c74))
* **json-type-validator:** 🎸 add support for refs ([703572e](https://github.com/streamich/json-joy/commit/703572e3d202200323aec825a42e844cda2e7d85))
* **json-type-validator:** 🎸 allow object keys of "any" type ([3494d60](https://github.com/streamich/json-joy/commit/3494d60e0be07b49c7fcc35c2d593b497332175c))
* **json-type-validator:** 🎸 implement "or" type in loop with consts ([92e5da6](https://github.com/streamich/json-joy/commit/92e5da61f341922d655cf004c386030750653def))
* **json-type-validator:** 🎸 improve "ref" type validation errors ([b7cd720](https://github.com/streamich/json-joy/commit/b7cd720080bc79e327f936baf91da1d71d84aa1e))
* **json-type-validator:** 🎸 improve public interface ([4c9861f](https://github.com/streamich/json-joy/commit/4c9861f1bfce2e4372828105ede030f6afea5f34))
* **json-type-validator:** 🎸 support validation of different int types ([952335a](https://github.com/streamich/json-joy/commit/952335ae565e0a029dac0d78f2fe358542dd36bc))
* **reactive-rpc:** 🎸 add ability for binary messages to encode msgpack ([1aa0094](https://github.com/streamich/json-joy/commit/1aa0094a16e23b708f46b68eaf6ce1ba39c87aa3))
* **reactive-rpc:** 🎸 add binary msgpack message encoder ([eba7b9b](https://github.com/streamich/json-joy/commit/eba7b9bc7ff08ecb25e22f4bfeb8cf7c91afc488))
* **reactive-rpc:** 🎸 add compacted json_string message encoder ([b0dcefe](https://github.com/streamich/json-joy/commit/b0dcefe7da7bebbbb85e50c544224cf0617cc282))
* **reactive-rpc:** 🎸 add polymorphic rpc methor return types ([5092490](https://github.com/streamich/json-joy/commit/5092490b4389ffa0fc72c181c3843e3e69e71658))
* **reactive-rpc:** 🎸 construct JSON messages in JSON server ([497dea5](https://github.com/streamich/json-joy/commit/497dea5df1b8b47b2f7f417041402cbfd9ca85f4))
* **reactive-rpc:** 🎸 dont wrap in array a single message ([f3dbec4](https://github.com/streamich/json-joy/commit/f3dbec47dad1bb00ae3f6e395ebe9b781679d70b))
* **reactive-rpc:** 🎸 implement JSON messages ([244dc1b](https://github.com/streamich/json-joy/commit/244dc1b41f6abd5b1db9d0ae44232d4895b57382))
* **reactive-rpc:** 🎸 implement polymorphic ApiCaller methods ([db2f0c6](https://github.com/streamich/json-joy/commit/db2f0c6298cc839e55f3d7d9889477d429adb62f))
* **reactive-rpc:** 🎸 implement RpcServerJson and RpcServerMsgPack ([900e4d9](https://github.com/streamich/json-joy/commit/900e4d942889b6184c3f819a4fa7bb7ece0a65c5))
* **reactive-rpc:** 🎸 improve RPC method wrappers ([49ab49b](https://github.com/streamich/json-joy/commit/49ab49bdc5f8776b6831b6fd1eba5b3018176745))
* **reactive-rpc:** 🎸 remove timeout tracking feature ([75c47d7](https://github.com/streamich/json-joy/commit/75c47d70cb40e42941cf3688bf0297b839e36253))
* **reactive-rpc:** 🎸 start json message implementation ([2aada7c](https://github.com/streamich/json-joy/commit/2aada7c438801512bdfad19a32fa71b48e08256c))
* **reactive-rpc:** 🎸 support static polymorphic calls in RpcServer ([3f0f8d6](https://github.com/streamich/json-joy/commit/3f0f8d607b7d3275d170ad48b210a0dd8208a2f6))
* **reactive-rpc:** 🎸 use binary RpcServer in ws compact binary mode ([4399322](https://github.com/streamich/json-joy/commit/43993228b79d7cfd5482d9cce1a7bf2fad04d2aa))
* **reactive-rpc:** 🎸 use RpcServerMsgPack in binary WebSocket server ([18f46c5](https://github.com/streamich/json-joy/commit/18f46c52d7ec001b1b6659461adcca5fd3a3c509))
* **reactive-rpc:** 🎸 use shared encoder and decoder ([12a5771](https://github.com/streamich/json-joy/commit/12a577138917b5157233eb99c315e28b17c4d4c4))
* **reactive-rpc:** 🎸 use specialized encoders in ws compact rpc ([36dd21a](https://github.com/streamich/json-joy/commit/36dd21ae856383dfee7919ded5d3d7a5e3345dc0))
* **util:** 🎸 allow to provide codegen params at last step ([756c525](https://github.com/streamich/json-joy/commit/756c525ab2abb206e5c9a02315ef6d7f53528b31))
* **util:** 🎸 improve code-generation types ([f3be5fd](https://github.com/streamich/json-joy/commit/f3be5fd4c0be6eea28b6c68e3c5f1faaae56624b))
* **util:** 🎸 vendor word wrap utility ([16e1ac0](https://github.com/streamich/json-joy/commit/16e1ac057ac9f681c2407453e1cae1f62a960d75))
* 🎸 add binary type to json-type ([fb48c45](https://github.com/streamich/json-joy/commit/fb48c45e0b3fbde388658abf90f661d31c75b615))
* 🎸 add code generation for array ([d3db9eb](https://github.com/streamich/json-joy/commit/d3db9eb78aa166fa85ae3206224b47ab19abac7a))
* 🎸 add compilation for basic types ([df1044b](https://github.com/streamich/json-joy/commit/df1044b5157508ee85d3f81f89dc4becc03d870d))
* 🎸 add convenience getters to json-type builder ([fcc3197](https://github.com/streamich/json-joy/commit/fcc31977660ea194297797aec041b7271b824b22))
* 🎸 add initial typing setup ([e1be097](https://github.com/streamich/json-joy/commit/e1be09748f0afba8526b64badb99f4325cddd098))
* 🎸 add support for optional fields in objects ([30453ff](https://github.com/streamich/json-joy/commit/30453ff34fbe4e13b213818b01f70ee42d62f0c2))
* 🎸 begin implementation of schema MessagePack serializer ([c65e3c8](https://github.com/streamich/json-joy/commit/c65e3c832c5432967fcea1e6b7960f456fd7d373))
* 🎸 implement boolean expressions ([e8f6ba9](https://github.com/streamich/json-joy/commit/e8f6ba954d2eb94628831673ec6a3c9c0a4c26e7))
* 🎸 improve JSON types ([b5ee20e](https://github.com/streamich/json-joy/commit/b5ee20e9fdf8db5232d43cf4711d245e6bbcfcbb))
* 🎸 improve JSON types and add builder ([a68d676](https://github.com/streamich/json-joy/commit/a68d676642c9bddce4b2b3c8949e354816597110))
* 🎸 improve json-type MessagePack encoding ([ddfab64](https://github.com/streamich/json-joy/commit/ddfab641f36bf3a72dd286e3a65f49baf2b59b67))
* 🎸 start json-expression implementation ([3d441f5](https://github.com/streamich/json-joy/commit/3d441f5516e54f7b02b4b95fa751d5ee25ae805e))


### Performance Improvements

* **json-expression:** ⚡️ add benchmark ([08a0eaa](https://github.com/streamich/json-joy/commit/08a0eaa956e95597bfa487f3705fead464eb6117))
* **json-pointer:** ⚡️ use hasOwnProperty() literal ([f26a1d6](https://github.com/streamich/json-joy/commit/f26a1d6a7011b894820d8cea6a66130325a3fa98))
* **json-type-codegen:** ⚡️ add benchmark ([10093a9](https://github.com/streamich/json-joy/commit/10093a968e0797e222d7fc47ffdc4fae99df3140))
* **json-type-codegen:** ⚡️ emit octets in chunks ([4d0e260](https://github.com/streamich/json-joy/commit/4d0e2606e4bae76a5947910735bcea466f31234b))
* **json-type-codegen:** ⚡️ emit octets on optional object keys ([d616407](https://github.com/streamich/json-joy/commit/d6164079b7ac68d44b41e363ea987a9cd184af48))
* **json-type-codegen:** ⚡️ improve json-type validator performance ([455df96](https://github.com/streamich/json-joy/commit/455df96a0cb7f26ae77d152c9817a632b1c740d2))
* **json-type-codegen:** ⚡️ improve optional object field check ([758b461](https://github.com/streamich/json-joy/commit/758b46118de3ef1f16ca6ce3665ab4b56bb3e794))
* **json-type-codegen:** ⚡️ optimize case for simple primitives ([416373a](https://github.com/streamich/json-joy/commit/416373a19e72144c5f6b8e4f028926e6bb199b17))
* **json-type-codegen:** ⚡️ write directly to Uint8Array ([94eedcb](https://github.com/streamich/json-joy/commit/94eedcb1085cffc0051403881e5b5410b6a28194))
* **json-type-serializer:** ⚡️ add MsgPack optimization for ASCII enc ([0c99c55](https://github.com/streamich/json-joy/commit/0c99c550810c94e6a251d9244c3d8b4ece946353))
* **json-type-serializer:** ⚡️ add support for "noJsonEscape" ([8f75ca3](https://github.com/streamich/json-joy/commit/8f75ca3c9b272dbc4c9403a828b03daeb7825928))
* **json-type-system:** ⚡️ remove unused argument ([cb3a218](https://github.com/streamich/json-joy/commit/cb3a218003f5f6c6d7fb668f4ac5d4294a634800))
* **util:** ⚡️ generate 64 x 64 table in Base64 encoding ([43447e2](https://github.com/streamich/json-joy/commit/43447e2194d98b8d9119943bb9a87b46253e704a))
* **util:** ⚡️ make word wrap return a list of lines ([0e07b32](https://github.com/streamich/json-joy/commit/0e07b3238418ab5d8e08c897889826a67d1df3a5))
* **util:** ⚡️ optimize base64 encoder ([5f685c6](https://github.com/streamich/json-joy/commit/5f685c69182bd93d2eb84a61e3630409fbc1e5ea))
* **util:** ⚡️ optimize base64 encoder performance ([ea64208](https://github.com/streamich/json-joy/commit/ea642084f5901c534b24fd557710a106472aeff9))


### BREAKING CHANGES

* **reactive-rpc:** 🧨 Streaming Reactive-RPC do not track inactivity timeout anymore.
