...
const config: StorybookConfig = {
  ...
  webpackFinal: async (config) => {
    ...
    config.resolve.alias = {
      ...
      'mu-txt-react/lib': resolve(__dirname, '../packages/mu-txt-react/src'),
      'mu-txt-react': resolve(__dirname, '../packages/mu-txt-react/src'),
      'mu-txt-element/lib': resolve(__dirname, '../packages/mu-txt-element/src'),
      'mu-txt-element': resolve(__dirname, '../packages/mu-txt-element/src'),
      '@jsonjoy.com/mu-txt-react/lib': resolve(__dirname, '../packages/mu-txt-react/src'),
      '@jsonjoy.com/mu-txt-react': resolve(__dirname, '../packages/mu-txt-react/src'),
