  ...
  describe('"upd" action', () => {
    ...
    describe('data', () => {
      ...
      test('can update the correct tag data', () => {
        ...
        expect(kit.toHtml()).toBe(
          '<p>abcdefgh</p><ul data-attr=\'{"type":"tasks"}\'><li data-attr=\'{"done":false}\'>ijklmnopqrstuvwxyz</li></ul>',
        );
        kit.et.marker({
          action: 'upd',
          target: ['data', 0],
          ops: [['add', '/type', 'ordered']],
        });
        expect(kit.toHtml()).toBe(
          '<p>abcdefgh</p><ul data-attr=\'{"type":"ordered"}\'><li data-attr=\'{"done":false}\'>ijklmnopqrstuvwxyz</li></ul>',
        );
        kit.et.marker({
          action: 'upd',
          target: ['data', 1],
          ops: [['replace', '/done', true]],
        });
        expect(kit.toHtml()).toBe(
          '<p>abcdefgh</p><ul data-attr=\'{"type":"ordered"}\'><li data-attr=\'{"done":true}\'>ijklmnopqrstuvwxyz</li></ul>',
        );
      });
    });
  });
