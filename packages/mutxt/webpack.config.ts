...
const config: Configuration & {devServer?: DevServerConfiguration} = {
  ...
  plugins: [
    ...
    new CopyPublicAssetsPlugin([
      ...
      {from: 'favicon.png'},
      {from: 'icons/mutxt-16.png'},
      {from: 'icons/mutxt-32.png'},
      {from: 'icons/mutxt-64.png'},
      {from: 'icons/mutxt-128.png'},
      {from: 'icons/mutxt-256.png'},
      {from: 'icons/mutxt-192.png'},
      {from: 'icons/mutxt-512.png'},
    ]),
