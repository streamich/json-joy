...
import {FieldList, type FieldListProps} from '../index';
...
export const Default: StoryObj<FieldListProps> = {
  args: {
    item: {
      name: 'Open Link',
      compact: true,
...
export const Interactive: StoryObj<FieldListProps> = {
  args: {
    item: {
      name: 'Create Event',
      compact: true,
...
export const LiveTweaks: StoryObj<FieldListProps> = {
  args: {
    item: {
      name: 'Tweak',
      compact: true,
...
export const LongSelectList: StoryObj<FieldListProps> = {
  args: {
    item: {
...
export const MinimalBoolOnly: StoryObj<FieldListProps> = {
  args: {
    item: {
      name: 'Preferences',
      compact: true,
...
export const AllOptional: StoryObj<FieldListProps> = {
  args: {
    item: {
      name: 'Export Options',
      compact: true,
