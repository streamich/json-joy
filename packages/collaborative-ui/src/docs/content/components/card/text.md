The *cards* are block components which are usually sized as a square-like card---they
...
```ts
import {Component, ComponentProps} from '@jsonjoy.com/ui/lib/4-card/Component';
```
