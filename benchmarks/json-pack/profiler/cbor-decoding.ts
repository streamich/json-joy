// NODE_ENV=production node --prof -r ts-node/register benchmarks/json-pack/profiler/cbor-decoding.ts
...
const payload = [
  0, 1, 2, 333, -333, 44444, -55555, 556666, -6666666, 62343423432,
  0.123, 0.0, -123.3434343, 127, 128, 129, 255, 256,
